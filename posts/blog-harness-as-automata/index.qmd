---
title: "Why Harness Works and Why I Think It Is Not Important"
description: "从自动机、非确定图灵机和复杂度理论重新理解 Harness"
author: "Tengyue Zhang"
date: "2026-05-19"
categories: [blog]
image: "/files/images/blog_icon_260519.jpg"
# css: /custom.css
# draft: true
---
...
harness 的第一层意义，不是“让模型更聪明”，而是把模型放进反馈回路。如果说，裸 LLM 可以看作一个单步生成的开环系统 $y \sim M(\cdot \mid x)$, 那么控制论意义上的 harness 则是闭环：
$$
\text{state} \rightarrow \text{model action} \rightarrow \text{environment/tool} \rightarrow \text{observation} \rightarrow \text{state update}.
$$
