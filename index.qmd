...
As an AI freshman with a background in physics, I emphasize using physical intuition and methodology to understand and study AI. My current research interests lie at the intersection of AI and physics, particularly Quantum Machine Learning (QML) and Physics-Informed Neural Networks (PINNs). I am also highly interested in multimodal learning, reinforcement learning, and the design of novel neural architectures.

You can find a detailed overview of my research interests and experience in my [CV](files/cv_TengyueZhang_25Nov.pdf).
